...
export function pegarCurso(slug: string | null) {
  try {
    return db
      .prepare(
        `
...
export function pegarAulas(cursoSlug: string | null) {
  try {
    return db
      .prepare(
        `
...
export function pegarAula(cursoSlug: string | null, aulaSlug: string | null) {
  try {
    return db
      .prepare(
        `
